...
def upgrade() -> None:
    ...
    op.add_column('routine_submission', sa.Column('duration', sa.Interval(), nullable=True))
    op.add_column('routine_submission', sa.Column('completion_timestamp', sa.DateTime(), nullable=False))
